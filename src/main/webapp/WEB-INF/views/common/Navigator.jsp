  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <c:choose>
	      ...
	      <c:when test="${session.accessCode eq 'admin'}"> <!-- DB에 어드민 코드를 담을 것 -->
		      <ul class="nav navbar-nav navbar-right">
		        <li><a href="#"><span class="glyphicon glyphicon-log-in"></span>관리자 접속중</a></li>
		        <li><a id="a_join"><span class="glyphicon glyphicon-log-in"></span>관리자 접속해제</a></li>
		      </ul>
	      </c:when>
